...
//
// class GoogleAccountUser extends StatelessWidget {
//   GoogleAccountUser({super.key});
//
...
//                     AppUtils().toast('براہ کرم نام درج کریں۔');
...
//                       }
//
//                       // Proceed with account creation if the email does not exist
//                       // Call signUpWithEmail if the email does not exist
//                       await createAcc
//                           .signUpWithEmail(emailCon.text, passCon.text)
//                           .then((val) async {
...
//                     } catch (e) {
//                       context.loaderOverlay.hide();
//                       AppUtils().toast('یہ ای میل پہلے سے موجود ہے۔');
//                     }
//                   }
//                 },
//                 // onPressed: () async {
